...
function descargarCV() {
    // Crear un elemento 'a' (hipervínculo) en el documento
    var enlaceDescarga = document.createElement('a');
    
    // Establecer el atributo 'href' con la ruta de tu archivo PDF
    enlaceDescarga.href = 'CV Alejandro Donaire.pdf';
    
    // Establecer el atributo 'download' con el nombre que deseas para el archivo descargado
    enlaceDescarga.download = 'CV Alejandro Donaire.pdf';
